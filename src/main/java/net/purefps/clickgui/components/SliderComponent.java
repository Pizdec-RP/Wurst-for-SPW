...
import net.purefps.clickgui.screens.EditSliderScreen;
import net.purefps.settings.SliderSetting;

public final class SliderComponent extends Component
{
	private final MinecraftClient MC = PFPSClient.MC;
	private final ClickGui GUI = PFPSClient.INSTANCE.getGui();
