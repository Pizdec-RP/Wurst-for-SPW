...
import net.purefps.clickgui.components.BlockComponent;
...
public final class BlockSetting extends Setting
{
	...
	{
		if((block == null) || (!allowAir && block instanceof AirBlock))
			return;
	...
	public void fromJson(JsonElement json)
	{
		try
		{
			...
			if((newBlock == null) || (!allowAir && newBlock instanceof AirBlock))
