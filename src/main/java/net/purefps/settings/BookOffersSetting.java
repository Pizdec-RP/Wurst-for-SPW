...
import net.purefps.clickgui.components.BookOffersEditButton;
import net.purefps.keybinds.PossibleKeybind;
import net.purefps.modules.autolibrarian.BookOffer;
...
public final class BookOffersSetting extends Setting
{
	...
	public void add(BookOffer offer)
	{
		...
		if(offer == null || !offer.isValid() || contains(offer))
			return;
	...
	public void replace(int index, BookOffer offer)
	{
		...
		if(index < 0 || index >= offers.size() || offer == null || !offer.isValid())
			return;
