...
public final class NavigatorMainScreen extends NavigatorScreen
{
	...
	public NavigatorMainScreen()
	{
		...
		Navigator navigator = PFPSClient.INSTANCE.getNavigator();
	...
	protected void onMouseClick(double x, double y, int button)
	{
		...
		{
			PFPSClient.MC.setScreen((Screen)null);
			return;
		}
		...
		float partialTicks)
	{
		...
		if(!clickTimerRunning)
		{
			...
			context.drawTextWithShadow(PFPSClient.MC.textRenderer, "Search: ",
