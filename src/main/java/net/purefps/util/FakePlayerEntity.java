...
{
	private final ClientPlayerEntity player = PFPSClient.MC.player;
	private final ClientWorld world = PFPSClient.MC.world;

	public FakePlayerEntity()
	{
		super(PFPSClient.MC.world, PFPSClient.MC.player.getGameProfile());
