...
import net.purefps.RotationFaker;
...
public enum RotationUtils
{
	...
	{
		RotationFaker rotationFaker = PFPSClient.INSTANCE.getRotationFaker();
	...
	{
		Rotation needed = getNeededRotations(vec);
		return MathHelper.wrapDegrees(PFPSClient.MC.player.getYaw())
			- needed.yaw;
	}
	...
	{
		Entity player = PFPSClient.MC.player;
