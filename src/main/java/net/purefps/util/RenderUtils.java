...
public enum RenderUtils
{
	...
	public static void scissorBox(int startX, int startY, int endX, int endY)
	{
		...
		int bottomY = PFPSClient.MC.currentScreen.height - endY;
		double factor = PFPSClient.MC.getWindow().getScaleFactor();
	...
	{
		Camera camera = PFPSClient.MC.getBlockEntityRenderDispatcher().camera;
		if(camera == null)
			return Vec3d.ZERO;
