...
import net.purefps.altmanager.AltRenderer;
import net.purefps.altmanager.AltsFile;
import net.purefps.altmanager.CrackedAlt;
import net.purefps.altmanager.ExportAltsFileChooser;
import net.purefps.altmanager.ImportAltsFileChooser;
import net.purefps.altmanager.LoginException;
import net.purefps.altmanager.MojangAlt;
import net.purefps.altmanager.NameGenerator;
import net.purefps.util.ListWidget;
import net.purefps.util.MultiProcessingUtils;
...
public final class AltManagerScreen extends Screen
{
	...
	private void pressImportAlts()
	{
		try
		{
			Process process = MultiProcessingUtils.startProcessWithIO(
				...
				PFPSClient.INSTANCE.getWurstFolder().toString());
		...
		int mouseY)
	{
		...
		{
			if(!button.isSelected() || (button != importButton && button != exportButton))
				continue;
	...
	{
		// translate
		String translated = PFPSClient.INSTANCE
			.translate("description.purefps.altmanager." + trKey);
