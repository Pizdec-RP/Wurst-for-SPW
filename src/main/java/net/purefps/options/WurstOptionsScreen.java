...
import net.purefps.modules.XRayHack;
...
public class WurstOptionsScreen extends Screen
{
	...
	{
		XRayHack xRayHack = PFPSClient.INSTANCE.getHax().xRayHack;
	...
	private void renderTitles(DrawContext context)
	{
		...
		context.drawCenteredTextWithShadow(tr, "PureFPS Options", middleX, y1,
			0xffffff);
