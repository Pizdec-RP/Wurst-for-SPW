...
public final class KeybindProfilesScreen extends Screen
{
	...
	public void init()
	{
		listGui = new ListGui(client, this,
			PFPSClient.INSTANCE.getKeybinds().listProfiles());
	...
	private void openFolder()
	{
		Util.getOperatingSystem().open(
			PFPSClient.INSTANCE.getKeybinds().getProfilesFolder().toFile());
	}
	...
	private void newProfile(String name)
	{
		...
		try
		{
			PFPSClient.INSTANCE.getKeybinds().saveProfile(name);
	...
	private void loadSelected()
	{
		...
		try
		{
			PFPSClient.INSTANCE.getKeybinds().loadProfile(fileName);
			openPrevScreen();
