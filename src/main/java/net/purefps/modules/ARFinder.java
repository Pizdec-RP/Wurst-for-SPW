...
public final class ARFinder extends Hack implements UpdateListener, RenderListener
{
    ...
    public void onEnable() {
        ARFinder.EVENTS.add(UpdateListener.class, this);
        ARFinder.EVENTS.add(RenderListener.class, this);
    }
    
    public void onDisable() {
        ARFinder.EVENTS.remove(UpdateListener.class, this);
        ARFinder.EVENTS.remove(RenderListener.class, this);
