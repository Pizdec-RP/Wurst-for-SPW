...
import net.purefps.modules.autofish.AutoFishDebugDraw;
import net.purefps.modules.autofish.AutoFishRodSelector;
import net.purefps.modules.autofish.ShallowWaterWarningCheckbox;
	...
	implements UpdateListener, PacketInputListener, RenderListener
{
	...
	public void onReceivedPacket(PacketInputEvent event)
	{
		...
		if(!(event.getPacket() instanceof PlaySoundS2CPacket sound) || !SoundEvents.ENTITY_FISHING_BOBBER_SPLASH
			.equals(sound.getSound().value()) || !isFishing())
			return;
