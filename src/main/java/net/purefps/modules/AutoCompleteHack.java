...
import net.purefps.modules.autocomplete.ApiProviderSetting;
import net.purefps.modules.autocomplete.MessageCompleter;
import net.purefps.modules.autocomplete.ModelSettings;
import net.purefps.modules.autocomplete.OobaboogaMessageCompleter;
import net.purefps.modules.autocomplete.OpenAiMessageCompleter;
import net.purefps.modules.autocomplete.SuggestionHandler;
	...
	implements ChatOutputListener, UpdateListener
{
	...
	public void onUpdate()
	{
		...
		if((timeSinceLastApiCall < 3000) || !(MC.currentScreen instanceof ChatScreen) || draftMessage == null || suggestionsUpdater == null)
			return;
