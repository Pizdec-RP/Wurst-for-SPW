...
import net.purefps.util.BlockPlacer;
import net.purefps.util.BlockPlacer.BlockPlacingParams;
	...
	implements UpdateListener, RenderListener
{
	...
	public void onUpdate()
	{
		...
		if(WURST.getHax().freecamHack.isEnabled() || (!fastPlace.isChecked() && MC.itemUseCooldown > 0))
			return;
	...
	private boolean tryToPlaceBlock(BlockPos pos)
	{
		...
		if(params == null || params.distanceSq() > range.getValueSq() || (checkLOS.isChecked() && !params.lineOfSight()))
			return false;
