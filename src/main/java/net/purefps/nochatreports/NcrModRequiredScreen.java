...
public final class NcrModRequiredScreen extends Screen
{
	...
	public NcrModRequiredScreen(Screen prevScreen)
	{
		...
		OtfList otfs = PFPSClient.INSTANCE.getOtfs();
	...
	{
		return PFPSClient.INSTANCE.translate("options." + (on ? "on" : "off"))
			.toUpperCase();
	}
	...
	{
		PFPSClient.INSTANCE.getOtfs().vanillaSpoofOtf.doPrimaryAction();
